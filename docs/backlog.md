...
- **Acceptance Criteria**:
    ...
    - [x] 武器と属性を統合した複合アイコン実装（Walkthrough: https://file:///C:/Users/audih/.gemini/antigravity/brain/f094922c-f576-4b22-a63a-b05c84a3a4db/walkthrough.md）。
...
- **Acceptance Criteria**:
    - [ ] `v15-col-anchor` と `v15-col-spec` の幅・配置の見直しが完了している。
    - [ ] スキル名やボーナス情報の表示領域が拡大され、視認性が向上している。
    - [ ] 情報の優先順位に基づいた新しい v15 HUD 用の各カラム比率が定義されている。
